...
function RageUI.CustomGrid(Type, StartedX, StartedY, TopText, BottomText, LeftText, RightText, Action, Index)
    if Type == "Default" then
        UIGridPanel(Type, StartedX, StartedY, TopText, BottomText, LeftText, RightText, Action, Index)
    else
