...
function RageUI.RenderVehicule(Dictionary, Texture)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() then
            RenderSprite(Dictionary, Texture, CurrentMenu.X + 510, CurrentMenu.Y-410 + VehiclePanel.Background.Y + CurrentMenu.SubtitleHeight + 410 + (RageUI.StatisticPanelCount * 42), VehiclePanel.Background.Width + CurrentMenu.WidthOffset, VehiclePanel.Background.Height + 200, 0, 255, 255, 255, 255);
            RageUI.StatisticPanelCount = RageUI.StatisticPanelCount + 1
        end
    end
end
